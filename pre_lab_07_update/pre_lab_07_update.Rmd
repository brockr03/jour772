...
```{r echo=FALSE}
census_api_key("40c2313fc1a231b500335ab147c5d6764b80fdd4", install=TRUE)
```
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer** household_income_breakdown_md
...
Is the difference between Calvert and Montgomery significant? **Answer** The difference is slightly significant - roughly 3,000

Is the difference between Howard and everyone else significant? **Answer** Yes, they are the highest earning by a LOT. 
