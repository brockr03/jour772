...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** There is a bar chart which displays the data of total 911 calls per month. It is not organized by least-greatest, but by month.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** Now the bars are ordered from least to greatest. This makes it easier to read the over-all trend of the data.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** Now the axis has been flipped, this will make it easier to read longer label names.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The chart over-all looks cleaner and more minimalist.
...
baltco_911_calls_by_month |>
  ...
  labs(
    ...
    x = "month",
    y = "total calls",
    caption = "source: Baltimore County. Graphic by Bex Heimbrock. 10-27-2025"
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** This code created a dataset with two columns, one with 'date' sorted as yyyy/mm/dd and one with the total amount of calls per date. This is generally a more specific table than the previous set which sorted totals by month.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Now we have a chart that looks like a new-age heavy metal tattoo. This chart plots the variation in calls. It actually reminds me of the covid trend charts published by outlets like the Times at the start of the pandemic. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Now it's really an abstract metal tattoo. We have a more specific graph that shows calls per week. Unfortunately, there isn't enough room on the X axis for the labels.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Now we have an X axis that shows the weeks with enough space to render it readable. 
